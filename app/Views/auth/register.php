                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= url_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="name" class="form-control form-control-user <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" name="username" placeholder="<?= lang('Auth.username') ?>" value="<?= old('username') ?>">
                                    </div>
